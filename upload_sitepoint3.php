...
$photo = new Photo_upload($identi, 3);
$photo -> creer_Photo($identi,$size,3);
$photo -> set_date_upload($photo->getNom());
MAJ_branche($photo->getNom(),3);
...
<script>
	...
	var adra = document.getElementById("adresse_photo3");

	var adresse_photo_3 = <?php echo json_encode($identi); ?>;

	adra.innerHTML =  adresse_photo_3;
